...
<div class="sidebar-nav" style="height:100%; width:80%;">
       ...
       <ul id="navigation">
    <li><a href="#" data-target=".cc-menu" class="nav-header" data-toggle="collapse"><i class="fa fa-fw fa-bolt"></i>Cost<i class="fa fa-collapse"></i></a></li>
...
<li>   <ul class="acc-menu nav nav-list collapse in">
    ...
    <p id="back-to-top"><a href="#top"><span></span>Back to Top</a></p>  
        ...
        <div class="header">
            <h1 class="page-title">Electricity cost in 24 hours</h1>
 <ul class="breadcrumb">
...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            name: 'Inside',
            data: [0.2, 0.8, 0.8, 0.8, 1, 1.3, 1.5, 2.9, 1.9, 2.6, 1.6, 3, 4, 3.6, 4.5, 4.2, 4.5, 4.5, 4, 3.1, 2.7, 4, 2.7, 2.3, 2.3, 4.1, 7.7, 7.1, 5.6, 6.1, 5.8, 8.6, 7.2, 9, 10.9, 11.5, 11.6, 11.1, 11, 11, 10.7, 9.4, 9.8, 9.6, 9.8, 9.5, 8.5, 7.4, 7.6]
