            ...
            <li class="dropdown hidden-xs">
              ...
              <ul class="dropdown-menu">
               ...
               <li class="divider"></li>
                ...
                <li><a href="search.php">Set house parameter</a></li>
...
<li>   <ul class="acc-menu nav nav-list collapse in">
            ...
            <li ><a href="search.php" target="rightFrame"><span class="fa fa-caret-right"></span> Set house parameter</a></li>
...
<div>
     Heating Turn on(off): <input class="form-control" type="checkbox" name = "Switch" <?Checkbox($Switch2)?>>

    

<br />

Temprature: <input type = "number" name = "temperature" value = <?echo $Temp2;?> /><br /><br /><br />

     battery Turn on(off): <input class="form-control" type="checkbox" name = "Switch2" <?Checkbox($Switch3)?>>

   
<br />
State of charge: <input type = "number" name = "SOC" value = <?echo $SOC;?> /><br /><br /><br />
