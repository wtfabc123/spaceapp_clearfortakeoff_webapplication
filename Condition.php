	...
	<div style="position:fixed; width:100%;height:50px; z-index:1; overflow-x:visible;">
      <div class="navbar navbar-default" role="navigation" >
        <div class="navbar-header">
          ...
          <a class="" href="personal_index.php"><span class="navbar-brand"><span class="fa fa-fw fa-cloud"></span>Clear for take off</span></a>
          </div>
...
<li>   <ul class="acc-menu nav nav-list collapse in">
            ...
            <li ><a href="search.php" target="rightFrame"><span class="fa fa-caret-right"></span> View Weather considtion</a></li>
            <li ><a href="http://www.delayedagain.co.uk/?source=AW&campaign=fdk3&advert=D1&gclid=CjwKEAjwuuy4BRCvs43g9fX9mz4SJACiYydPjbnYe7f3XxHs5tWPL5MULy_bnWEmIyouvDiQ-ZUnkhoCjh7w_wcB" target="rightFrame"><span class="fa fa-caret-right"></span> Buy Insurence</a></li>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'The possibility fo delay is 70% and the Real time Price'
        },
               xAxis: {
            type: 'datetime',
            labels: {
